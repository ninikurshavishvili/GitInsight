...
ᵎ!ᵎThis application uses GitHub OAuth for authentication. Please ensure that your client secrets are not committed to the repository. Set up the following environment variables:
